...
urlpatterns = [
    ...
    path('wiladmin/updatereserved/<int:id>', views.AdminReservedDashboardController.as_view(), name='updatereserved'),
    path('wiladmin/deletereserved/<int:id>', views.AdminReservedDashboardController.as_view(), name='deletereserved'),
